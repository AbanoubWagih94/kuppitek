...
class MenuItemController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("admin.pages.item.index", ['MenuItems'=> $MenuItems, 'page_name' => $page_name, 'department_name' => $department_name]);
    }
    ...
    public function create()
    {
        ...
        return view("admin.pages.item.add",  [  'MenuCategories'=> $MenuCategories, 'page_name' => $page_name, 'department_name' => $department_name]);
    }
    ...
    public function edit($id)
    {
       ...
       $page_name = "category";
        ...
        return view("admin.pages.item.edit",  [  'MenuCategories'=> $MenuCategories, 'menu'=>$menu , 'page_name' => $page_name, 'department_name' => $department_name]);
    }
