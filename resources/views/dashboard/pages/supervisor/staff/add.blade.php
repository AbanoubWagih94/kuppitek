                        ...
                        <div class="container">
                            <form action="{{ Route('staff.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="number" name="country_id" id="country_id" class="form-control"  placeholder="Enter member country ID" required>
                                </div>
                                <div class="form-group">
                                  <label for="phone_number">Member Phone Number</label>
                                  <input type="number" name="phone_number" id="phone_number" class="form-control"  placeholder="Enter member phone number" required>
                                </div>
                                <div class="form-group">
