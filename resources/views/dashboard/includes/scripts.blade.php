...
<script src="{{ asset('assets/js/extensions/sweet-alerts.js') }}"  type="text/javascript"></script>
<script src="{{ asset('assets/js/extensions/sweetalert.min.js') }}"  type="text/javascript"></script>
