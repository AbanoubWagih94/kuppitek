...
@section('dashboard.content')    
                        <div class="">
                            ...
                            <button class="btn1" title="Counters"><a href="{{ route('counter.index') }}"><i class="fas fa-cash-register fa-2x"></i></a><span>Counters</span></button>
                            ...
                            <div class="">
                                <div class="btn-group">
                                    ...
                                    <button class="btn2" title="Customers"><a href="{{ route('customers.index') }}"><i class="fas fa-users fa-2x"></i></a><span>Customers</span></button>
                                </div>
                            </div>
                            <div class="">
                                <div class="btn-group">
                                    <button class="btn3" title="Branches"><a href="#"><i class="fas fa-store-alt fa-2x"></i></a><span>Branches</span></button>
                                    <button class="btn3" title="Suppliers"><a href="{{ route('supplier.index') }}"><i class="fas fa-dolly fa-2x"></i></a><span>Suppliers</span></button>
