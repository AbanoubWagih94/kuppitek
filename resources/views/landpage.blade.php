      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="book-a-table text-center">
            ...
            <a  data-toggle="modal" data-target="#cartModal">Book your Order</a></li>
        </ul>
      </nav><!-- .nav-menu -->
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="d-flex justify-content-end" id="carttotal">
            <h5  class="price text-success" >Total: <span class="price text-success">{{ Cart::subtotal() }}</span></h5>
          </div>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            ...
            <ul id="menu-flters">
              ...
              <li  data-filter="*" class="filter-active"><a  onclick="getitems({{$cat->id}})">{{$cat->title}} </a></li>
          @endforeach
          </ul>
            {{-- <ul id="menu-flters">
