    ...
    <div class="navbar-wrapper">
        ...
        <ul class="nav navbar-nav flex-row">
            ...
            <a class="navbar-brand" href="index.html">
                <img class="brand-logo" width="500px" alt="Kuppitek logo" src="{{url('/admin')}}/app-assets/images/logo/logo.png">
                <!--<h2 class="brand-text">Modern Admin</h3>-->
            </a>
            </li>
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
                ...
                <li class="col-md-2">
                    ...
                    <div>
                        <img class="rounded img-fluid mb-1" src="{{url('/admin')}}/app-assets/images/slider/slider-2.png"
            ...
            <li class="dropdown dropdown-user nav-item">
                ...
                <span class="avatar avatar-online">
                    <img src="{{url('/admin')}}/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
                </a>
                ...
                <li class="scrollable-container media-list w-100">
                    ...
                    <div class="media">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                            <img src="{{url('/admin')}}/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                            <img src="{{url('/admin')}}/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                            <img src="{{url('/admin')}}/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                        </div>
                        <div class="media-body">
