...
<div class="modal fade" id="cartModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="d-flex justify-content-end">
            <h5>الاجمالى : <span class="price text-success">{{ Cart::total() }}</span></h5>
          </div>
        </div>
        <div class="modal-footer border-top-0 d-flex justify-content-between">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
          <button type="button" class="btn btn-success">أضافة الطلب</button>
        </div>
      </div>
    </div>
  </div>
   ...
   <form action="{{url('allorder', 1)}}" method="POST">
    @csrf
   ...
   <h4 style="text-align: center" id="emailHelp" class="form-text text-muted">please complete your information to finish your order .</h4 style="text-align: center">
       ...
       <label for="exampleInputEmail1">أسمك</label>
       <input type="text" class="form-control" name="name" id="exampleInputEmail1"  placeholder="أدخل أسمك">
     </div>
     <div class="form-group">
     ...
     <button type="submit" class="btn btn-primary">أطلب ألان</button>
   </form>
